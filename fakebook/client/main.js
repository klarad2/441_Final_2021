...
Meteor.startup(() => {
  ...
  let allPostsInDB = USER_Posts_Access.find({/*empty to get all posts */}, {sort:{time: -1}}).fetch();

  let allCommentsInDB = USER_Comments_Access.find({/*empty to get all comments*/}, {sort:{time: -1}}).fetch();
